...
func (r *elasticRepository) PutProduct(context context.Context, p Product) error {
...
func (r *elasticRepository) GetProductByID(context context.Context, id string) (*Product, error) {
...
func (r *elasticRepository) ListProducts(context context.Context, skip, take uint64) ([]Product, error) {
